...
function bt(e, t) {
  const r = e[0] * t[0][0] + e[1] * t[0][1] + e[2] * t[0][2],
    n = e[0] * t[1][0] + e[1] * t[1][1] + e[2] * t[1][2],
    a = e[0] * t[2][0] + e[1] * t[2][1] + e[2] * t[2][2];
  return [r, n, a];
}
/**
 * @license
...
function St(e, t, r) {
  const n = Yt,
    a = n[0][0] * e + n[0][1] * t + n[0][2] * r,
    o = n[1][0] * e + n[1][1] * t + n[1][2] * r,
    s = n[2][0] * e + n[2][1] * t + n[2][2] * r,
    c = tt(a),
    u = tt(o),
    h = tt(s);
  return ft(c, u, h);
...
function Xt(e) {
  const t = $(dt(e)),
    ...
    n = $(gt(e)),
    a = zt,
    o = a[0][0] * t + a[0][1] * r + a[0][2] * n,
    s = a[1][0] * t + a[1][1] * r + a[1][2] * n,
    c = a[2][0] * t + a[2][1] * r + a[2][2] * n,
    u = wt,
    h = o / u[0],
    l = s / u[1],
    d = c / u[2],
 ...
 */ class v {
  static make(
    ...
    const s = t,
      c = s[0] * 0.401288 + s[1] * 0.650173 + s[2] * -0.051461,
      u = s[0] * -0.250268 + s[1] * 1.204414 + s[2] * 0.045854,
      h = s[0] * -0.002079 + s[1] * 0.048952 + s[2] * 0.953127,
      l = 0.8 + a / 10,
      d =
        l >= 0.9
          ? nt(0.59, 0.69, (l - 0.9) * 10)
          : nt(0.525, 0.59, (l - 0.8) * 10);
    let p = o ? 1 : l * (1 - (1 / 3.6) * Math.exp((-r - 42) / 92));
    p = p > 1 ? 1 : p < 0 ? 0 : p;
    const f = l,
      M = [p * (100 / c) + 1 - p, p * (100 / u) + 1 - p, p * (100 / h) + 1 - p],
      g = 1 / (5 * r + 1),
      b = g * g * g * g,
      w = 1 - b,
      y = b * r + 0.1 * w * w * Math.cbrt(5 * r),
      k = Q(n) / t[1],
      A = 1.48 + Math.sqrt(k),
      D = 0.725 / Math.pow(k, 0.2),
      R = D,
      P = [
        Math.pow((y * M[0] * c) / 100, 0.42),
        Math.pow((y * M[1] * u) / 100, 0.42),
        Math.pow((y * M[2] * h) / 100, 0.42),
      ],
      I = [
        (400 * P[0]) / (P[0] + 27.13),
        (400 * P[1]) / (P[1] + 27.13),
 ...
 */ class z {
  ...
  static fromIntInViewingConditions(t, r) {
    const n = (t & 16711680) >> 16,
      a = (t & 65280) >> 8,
      o = t & 255,
      s = $(n),
      c = $(a),
      u = $(o),
      h = 0.41233895 * s + 0.35762064 * c + 0.18051042 * u,
      l = 0.2126 * s + 0.7152 * c + 0.0722 * u,
      d = 0.01932141 * s + 0.11916382 * c + 0.95034478 * u,
      p = 0.401288 * h + 0.650173 * l - 0.051461 * d,
      f = -0.250268 * h + 1.204414 * l + 0.045854 * d,
      M = -0.002079 * h + 0.048952 * l + 0.953127 * d,
      g = r.rgbD[0] * p,
      b = r.rgbD[1] * f,
      w = r.rgbD[2] * M,
      y = Math.pow((r.fl * Math.abs(g)) / 100, 0.42),
      k = Math.pow((r.fl * Math.abs(b)) / 100, 0.42),
      A = Math.pow((r.fl * Math.abs(w)) / 100, 0.42),
      D = (q(g) * 400 * y) / (y + 27.13),
      R = (q(b) * 400 * k) / (k + 27.13),
      P = (q(w) * 400 * A) / (A + 27.13),
      I = (11 * D + -12 * R + P) / 11,
      ...
      T = (20 * D + 20 * R + 21 * P) / 20,
      V = (40 * D + 20 * R + P) / 20,
      U = (Math.atan2(B, I) * 180) / Math.PI,
      L = U < 0 ? U + 360 : U >= 360 ? U - 360 : U,
      Z = (L * Math.PI) / 180,
      st = V * r.nbb,
      K = 100 * Math.pow(st / r.aw, r.c * r.z),
      it = (4 / r.c) * Math.sqrt(K / 100) * (r.aw + 4) * r.fLRoot,
      pt = L < 20.14 ? L + 360 : L,
      yt = 0.25 * (Math.cos((pt * Math.PI) / 180 + 2) + 3.8),
      kt =
        ((5e4 / 13) * yt * r.nc * r.ncb * Math.sqrt(I * I + B * B)) /
        (T + 0.305),
      ct = Math.pow(kt, 0.9) * Math.pow(1.64 - Math.pow(0.29, r.n), 0.73),
      Bt = ct * Math.sqrt(K / 100),
      Rt = Bt * r.fLRoot,
      Vt = 50 * Math.sqrt((ct * r.c) / (r.aw + 4)),
      _t = ((1 + 100 * 0.007) * K) / (1 + 0.007 * K),
      Ft = (1 / 0.0228) * Math.log(1 + 0.0228 * Rt),
      Ht = Ft * Math.cos(Z),
      Ut = Ft * Math.sin(Z);
  ...
  static fromJchInViewingConditions(t, r, n, a) {
    const o = (4 / a.c) * Math.sqrt(t / 100) * (a.aw + 4) * a.fLRoot,
      s = r * a.fLRoot,
      c = r / Math.sqrt(t / 100),
      u = 50 * Math.sqrt((c * a.c) / (a.aw + 4)),
      h = (n * Math.PI) / 180,
      l = ((1 + 100 * 0.007) * t) / (1 + 0.007 * t),
      d = (1 / 0.0228) * Math.log(1 + 0.0228 * s),
      p = d * Math.cos(h),
      f = d * Math.sin(h);
    return new z(n, r, t, o, s, u, l, p, f);
  }
  ...
  static fromUcsInViewingConditions(t, r, n, a) {
    const o = r,
      s = n,
      c = Math.sqrt(o * o + s * s),
      h = (Math.exp(c * 0.0228) - 1) / 0.0228 / a.fLRoot;
    let l = Math.atan2(s, o) * (180 / Math.PI);
    l < 0 && (l += 360);
    const d = t / (1 - (t - 100) * 0.007);
  ...
  viewed(t) {
    const r =
      ...
      n = Math.pow(r / Math.pow(1.64 - Math.pow(0.29, t.n), 0.73), 1 / 0.9),
      a = (this.hue * Math.PI) / 180,
      o = 0.25 * (Math.cos(a + 2) + 3.8),
      s = t.aw * Math.pow(this.j / 100, 1 / t.c / t.z),
      c = o * (5e4 / 13) * t.nc * t.ncb,
      u = s / t.nbb,
      h = Math.sin(a),
      l = Math.cos(a),
      d = (23 * (u + 0.305) * n) / (23 * c + 11 * n * l + 108 * n * h),
      p = d * l,
      f = d * h,
      M = (460 * u + 451 * p + 288 * f) / 1403,
      g = (460 * u - 891 * p - 261 * f) / 1403,
      b = (460 * u - 220 * p - 6300 * f) / 1403,
      w = Math.max(0, (27.13 * Math.abs(M)) / (400 - Math.abs(M))),
      y = q(M) * (100 / t.fl) * Math.pow(w, 1 / 0.42),
      k = Math.max(0, (27.13 * Math.abs(g)) / (400 - Math.abs(g))),
      A = q(g) * (100 / t.fl) * Math.pow(k, 1 / 0.42),
      D = Math.max(0, (27.13 * Math.abs(b)) / (400 - Math.abs(b))),
      R = q(b) * (100 / t.fl) * Math.pow(D, 1 / 0.42),
      P = y / t.rgbD[0],
      I = A / t.rgbD[1],
      B = R / t.rgbD[2],
      T = 1.86206786 * P - 1.01125463 * I + 0.14918677 * B,
      V = 0.38752654 * P + 0.62144744 * I - 0.00897398 * B,
      Y = -0.0158415 * P - 0.03412294 * I + 1.04996444 * B;
    return St(T, V, Y);
  }
  static fromXyzInViewingConditions(t, r, n, a) {
    const o = 0.401288 * t + 0.650173 * r - 0.051461 * n,
      s = -0.250268 * t + 1.204414 * r + 0.045854 * n,
      c = -0.002079 * t + 0.048952 * r + 0.953127 * n,
      u = a.rgbD[0] * o,
      h = a.rgbD[1] * s,
      l = a.rgbD[2] * c,
      d = Math.pow((a.fl * Math.abs(u)) / 100, 0.42),
      p = Math.pow((a.fl * Math.abs(h)) / 100, 0.42),
      f = Math.pow((a.fl * Math.abs(l)) / 100, 0.42),
      M = (q(u) * 400 * d) / (d + 27.13),
      g = (q(h) * 400 * p) / (p + 27.13),
      b = (q(l) * 400 * f) / (f + 27.13),
      w = (11 * M + -12 * g + b) / 11,
      ...
      k = (20 * M + 20 * g + 21 * b) / 20,
      A = (40 * M + 20 * g + b) / 20,
      R = (Math.atan2(y, w) * 180) / Math.PI,
      P = R < 0 ? R + 360 : R >= 360 ? R - 360 : R,
      I = (P * Math.PI) / 180,
      B = A * a.nbb,
      T = 100 * Math.pow(B / a.aw, a.c * a.z),
      V = (4 / a.c) * Math.sqrt(T / 100) * (a.aw + 4) * a.fLRoot,
      Y = P < 20.14 ? P + 360 : P,
      U = (1 / 4) * (Math.cos((Y * Math.PI) / 180 + 2) + 3.8),
      Z =
        ((5e4 / 13) * U * a.nc * a.ncb * Math.sqrt(w * w + y * y)) /
        (k + 0.305),
      st = Math.pow(Z, 0.9) * Math.pow(1.64 - Math.pow(0.29, a.n), 0.73),
      K = st * Math.sqrt(T / 100),
      it = K * a.fLRoot,
      pt = 50 * Math.sqrt((st * a.c) / (a.aw + 4)),
      yt = ((1 + 100 * 0.007) * T) / (1 + 0.007 * T),
      Mt = Math.log(1 + 0.0228 * it) / 0.0228,
      kt = Mt * Math.cos(I),
      ct = Mt * Math.sin(I);
 ...
 */ class C {
  ...
  static trueDelinearized(t) {
    ...
    return (
      r <= 0.0031308
        ? (n = r * 12.92)
        : (n = 1.055 * Math.pow(r, 1 / 2.4) - 0.055),
      n * 255
    );
  }
  ...
  static hueOf(t) {
    const r = bt(t, C.SCALED_DISCOUNT_FROM_LINRGB),
      n = C.chromaticAdaptation(r[0]),
      a = C.chromaticAdaptation(r[1]),
      o = C.chromaticAdaptation(r[2]),
      s = (11 * n + -12 * a + o) / 11,
      c = (n + a - 2 * o) / 9;
    return Math.atan2(c, s);
  }
  static areInCyclicOrder(t, r, n) {
    const a = C.sanitizeRadians(r - t),
      o = C.sanitizeRadians(n - t);
    return a < o;
  }
  ...
  static bisectToSegment(t, r) {
    ...
    for (let h = 0; h < 12; h++) {
      ...
      (u || C.areInCyclicOrder(o, d, s)) &&
        ((u = !1),
        C.areInCyclicOrder(o, r, d) ? ((a = l), (s = d)) : ((n = l), (o = d)));
    }
    return [n, a];
  }
  static midpoint(t, r) {
    ...
    for (let c = 0; c < 3; c++)
      if (a[c] !== s[c]) {
        let u = -1,
          h = 255;
        a[c] < s[c]
          ? ((u = C.criticalPlaneBelow(C.trueDelinearized(a[c]))),
            (h = C.criticalPlaneAbove(C.trueDelinearized(s[c]))))
          : ((u = C.criticalPlaneAbove(C.trueDelinearized(a[c]))),
            (h = C.criticalPlaneBelow(C.trueDelinearized(s[c]))));
        for (let l = 0; l < 8 && !(Math.abs(h - u) <= 1); l++) {
          const d = Math.floor((u + h) / 2),
            p = C.CRITICAL_PLANES[d],
            f = C.setCoordinate(a, p, s, c),
            M = C.hueOf(f);
          C.areInCyclicOrder(o, r, M)
            ? ((s = f), (h = d))
            : ((a = f), (o = M), (u = d));
        }
      }
  ...
  static inverseChromaticAdaptation(t) {
    const r = Math.abs(t),
      n = Math.max(0, (27.13 * r) / (400 - r));
    return q(t) * Math.pow(n, 1 / 0.42);
  }
  static findResultByJ(t, r, n) {
    let a = Math.sqrt(n) * 11;
    const o = v.DEFAULT,
      s = 1 / Math.pow(1.64 - Math.pow(0.29, o.n), 0.73),
      u = 0.25 * (Math.cos(t + 2) + 3.8) * (5e4 / 13) * o.nc * o.ncb,
      h = Math.sin(t),
      l = Math.cos(t);
    for (let d = 0; d < 5; d++) {
      const p = a / 100,
        f = r === 0 || a === 0 ? 0 : r / Math.sqrt(p),
        M = Math.pow(f * s, 1 / 0.9),
        b = (o.aw * Math.pow(p, 1 / o.c / o.z)) / o.nbb,
        w = (23 * (b + 0.305) * M) / (23 * u + 11 * M * l + 108 * M * h),
        y = w * l,
        k = w * h,
        A = (460 * b + 451 * y + 288 * k) / 1403,
        D = (460 * b - 891 * y - 261 * k) / 1403,
        R = (460 * b - 220 * y - 6300 * k) / 1403,
        P = C.inverseChromaticAdaptation(A),
        I = C.inverseChromaticAdaptation(D),
        B = C.inverseChromaticAdaptation(R),
        T = bt([P, I, B], C.LINRGB_FROM_SCALED_DISCOUNT);
      if (T[0] < 0 || T[1] < 0 || T[2] < 0) return 0;
      const V = C.Y_FROM_LINRGB[0],
        Y = C.Y_FROM_LINRGB[1],
        U = C.Y_FROM_LINRGB[2],
        L = V * T[0] + Y * T[1] + U * T[2];
      if (L <= 0) return 0;
      if (d === 4 || Math.abs(L - n) < 0.002)
        return T[0] > 100.01 || T[1] > 100.01 || T[2] > 100.01 ? 0 : Et(T);
      a = a - ((L - n) * a) / (2 * L);
    }
    return 0;
  }
 ...
 */ class E {
  ...
  constructor(t) {
    this.argb = t;
    const r = z.fromInt(t);
    (this.internalHue = r.hue),
      (this.internalChroma = r.chroma),
  ...
  inViewingConditions(t) {
    const n = z.fromInt(this.toInt()).xyzInViewingConditions(t),
      a = z.fromXyzInViewingConditions(n[0], n[1], n[2], v.make());
 ...
 */ class xt {
  static harmonize(t, r) {
    const n = E.fromInt(t),
      ...
      o = Nt(n.hue, a.hue),
      s = Math.min(o * 0.5, 15),
      c = Dt(n.hue + s * jt(n.hue, a.hue));
    return E.from(c, n.chroma, n.tone).toInt();
  }
  static hctHue(t, r, n) {
    const a = xt.cam16Ucs(t, r, n),
      o = z.fromInt(a),
      s = z.fromInt(t);
 ...
 */ class At {
  static isDisliked(t) {
    const r = Math.round(t.hue) >= 90 && Math.round(t.hue) <= 111,
 ...
 */ class m {
  ...
  getHct(t) {
    ...
    const n = this.getTone(t),
      a = this.palette(t).getHct(n);
    return (
      this.hctCache.size > 4 && this.hctCache.clear(),
      this.hctCache.set(t, a),
      a
    );
  }
  getTone(t) {
    ...
    if (this.toneDeltaPair) {
      const n = this.toneDeltaPair(t),
        ...
        M = this.name === p.name,
        g = t.isDark ? 1 : -1,
        b = p.contrastCurve.getContrast(t.contrastLevel),
        w = f.contrastCurve.getContrast(t.contrastLevel),
        y = p.tone(t);
      let k = N.ratioOfTones(l, y) >= b ? y : m.foregroundTone(l, b);
      const A = f.tone(t);
      let D = N.ratioOfTones(l, A) >= w ? A : m.foregroundTone(l, w);
      return (
        r && ((k = m.foregroundTone(l, b)), (D = m.foregroundTone(l, w))),
        (D - k) * g >= s ||
          ((D = ht(0, 100, k + s * g)),
          (D - k) * g >= s || (k = ht(0, 100, D - s * g))),
        50 <= k && k < 60
          ? g > 0
            ? ((k = 60), (D = Math.max(D, k + s * g)))
            : ((k = 49), (D = Math.min(D, k + s * g)))
          : 50 <= D &&
            D < 60 &&
            (u
              ? g > 0
      ...
      const a = this.background(t).getTone(t),
        o = this.contrastCurve.getContrast(t.contrastLevel);
      if (
        (N.ratioOfTones(a, n) >= o || (n = m.foregroundTone(a, o)),
        r && (n = m.foregroundTone(a, o)),
        this.isBackground &&
          50 <= n &&
          n < 60 &&
          (N.ratioOfTones(49, a) >= o ? (n = 49) : (n = 60)),
        this.secondBackground)
      ) {
        const [s, c] = [this.background, this.secondBackground],
          [u, h] = [s(t).getTone(t), c(t).getTone(t)],
          [l, d] = [Math.max(u, h), Math.min(u, h)];
        if (N.ratioOfTones(l, n) >= o && N.ratioOfTones(d, n) >= o) return n;
        const p = N.lighter(l, o),
          f = N.darker(d, o),
          M = [];
        return (
          p !== -1 && M.push(p),
          f !== -1 && M.push(f),
          m.tonePrefersLightForeground(u) || m.tonePrefersLightForeground(h)
            ? p < 0
              ? 100
              : p
            : M.length === 1
  ...
  static foregroundTone(t, r) {
    const n = N.lighterUnsafe(t, r),
      a = N.darkerUnsafe(t, r),
      o = N.ratioOfTones(n, t),
      s = N.ratioOfTones(a, t);
 ...
 */ class x {
  ...
  getContrast(t) {
    return t <= -1
      ? this.low
      : t < 0
      ? nt(this.low, this.normal, (t - -1) / 1)
      : t < 0.5
      ? nt(this.normal, this.medium, (t - 0) / 0.5)
      : t < 1
...
function Qt(e, t, r, n) {
  ...
  if (o.chroma < t) {
    ...
    for (; o.chroma < t; ) {
      ...
      const u = Math.abs(c.chroma - t),
        h = Math.abs(o.chroma - t);
...
function Tt(e, t) {
  ...
  return m.tonePrefersLightForeground(e.tone) &&
    !m.toneAllowsLightForeground(r.tone)
    ? m.enableLightForeground(e.tone)
    : m.enableLightForeground(r.tone);
}
class i {
...
i.onSurface = m.fromPalette({
  ...
  palette: (e) => e.neutralPalette,
  tone: (e) => (e.isDark ? 90 : 10),
  background: (e) => i.highestSurface(e),
...
i.primary = m.fromPalette({
  name: "primary",
  palette: (e) => e.primaryPalette,
  tone: (e) => (O(e) ? (e.isDark ? 100 : 0) : e.isDark ? 80 : 40),
  isBackground: !0,
  background: (e) => i.highestSurface(e),
  contrastCurve: new x(3, 4.5, 7, 11),
  toneDeltaPair: (e) => new j(i.primaryContainer, i.primary, 15, "nearer", !1),
});
i.onPrimary = m.fromPalette({
  name: "on_primary",
  palette: (e) => e.primaryPalette,
  tone: (e) => (O(e) ? (e.isDark ? 10 : 90) : e.isDark ? 20 : 100),
  background: (e) => i.primary,
  contrastCurve: new x(4.5, 7, 11, 21),
});
...
i.onPrimaryContainer = m.fromPalette({
  ...
  tone: (e) =>
    et(e)
      ? m.foregroundTone(i.primaryContainer.tone(e), 4.5)
      : O(e)
      ? e.isDark
        ? 0
        : 100
      ...
      ? 90
      : 10,
  background: (e) => i.primaryContainer,
  contrastCurve: new x(4.5, 7, 11, 21),
});
...
i.onSecondary = m.fromPalette({
  name: "on_secondary",
  palette: (e) => e.secondaryPalette,
  tone: (e) => (O(e) ? (e.isDark ? 10 : 100) : e.isDark ? 20 : 100),
  background: (e) => i.secondary,
  contrastCurve: new x(4.5, 7, 11, 21),
});
...
i.onSecondaryContainer = m.fromPalette({
  ...
  tone: (e) =>
    et(e)
      ? m.foregroundTone(i.secondaryContainer.tone(e), 4.5)
      : e.isDark
      ? 90
      : 10,
  background: (e) => i.secondaryContainer,
  contrastCurve: new x(4.5, 7, 11, 21),
});
i.tertiary = m.fromPalette({
  name: "tertiary",
  palette: (e) => e.tertiaryPalette,
  tone: (e) => (O(e) ? (e.isDark ? 90 : 25) : e.isDark ? 80 : 40),
  isBackground: !0,
  background: (e) => i.highestSurface(e),
  contrastCurve: new x(3, 4.5, 7, 11),
  toneDeltaPair: (e) =>
...
i.tertiaryContainer = m.fromPalette({
  ...
  tone: (e) => {
    ...
    const t = Tt(e.tertiaryPalette.getHct(e.sourceColorHct.tone), e),
      r = e.tertiaryPalette.getHct(t);
  ...
  tone: (e) =>
    O(e)
      ? e.isDark
        ...
        : 100
      : et(e)
      ? m.foregroundTone(i.tertiaryContainer.tone(e), 4.5)
      : e.isDark
      ? 90
      : 10,
  background: (e) => i.tertiaryContainer,
  contrastCurve: new x(4.5, 7, 11, 21),
});
i.error = m.fromPalette({
  ...
  background: (e) => i.highestSurface(e),
  contrastCurve: new x(3, 4.5, 7, 11),
  toneDeltaPair: (e) => new j(i.errorContainer, i.error, 15, "nearer", !1),
});
i.onError = m.fromPalette({
  name: "on_error",
  palette: (e) => e.errorPalette,
  tone: (e) => (e.isDark ? 20 : 100),
  background: (e) => i.error,
  contrastCurve: new x(4.5, 7, 11, 21),
});
...
i.onPrimaryFixed = m.fromPalette({
  ...
  palette: (e) => e.primaryPalette,
  tone: (e) => (O(e) ? 100 : 10),
  background: (e) => i.primaryFixedDim,
  secondBackground: (e) => i.primaryFixed,
  contrastCurve: new x(4.5, 7, 11, 21),
});
...
i.onSecondaryFixed = m.fromPalette({
  ...
  palette: (e) => e.secondaryPalette,
  tone: (e) => 10,
  background: (e) => i.secondaryFixedDim,
  secondBackground: (e) => i.secondaryFixed,
  contrastCurve: new x(4.5, 7, 11, 21),
});
...
i.onTertiaryFixed = m.fromPalette({
  ...
  palette: (e) => e.tertiaryPalette,
  tone: (e) => (O(e) ? 100 : 10),
  background: (e) => i.tertiaryFixedDim,
  secondBackground: (e) => i.tertiaryFixed,
  contrastCurve: new x(4.5, 7, 11, 21),
});
 ...
 */ class G {
  ...
  static createKeyColor(t, r) {
    let a = E.from(t, r, 50),
      o = Math.abs(a.chroma - r);
    for (let s = 1; s < 50; s += 1) {
      if (Math.round(r) === Math.round(a.chroma)) return a;
      const c = E.from(t, r, 50 + s),
        u = Math.abs(c.chroma - r);
      u < o && ((o = u), (a = c));
      const h = E.from(t, r, 50 - s),
        l = Math.abs(h.chroma - r);
      l < o && ((o = l), (a = h));
    }
    return a;
  }
  tone(t) {
    ...
    return (
      r === void 0 &&
        ((r = E.from(this.hue, this.chroma, t).toInt()), this.cache.set(t, r)),
      r
    );
  }
  getHct(t) {
 ...
 */ class S {
  ...
  constructor(t, r) {
    const n = E.fromInt(t),
      ...
      o = n.chroma;
    r
      ? ((this.a1 = G.fromHueAndChroma(a, o)),
        (this.a2 = G.fromHueAndChroma(a, o / 3)),
        (this.a3 = G.fromHueAndChroma(a + 60, o / 2)),
        (this.n1 = G.fromHueAndChroma(a, Math.min(o / 12, 4))),
        (this.n2 = G.fromHueAndChroma(a, Math.min(o / 6, 8))))
      : ((this.a1 = G.fromHueAndChroma(a, Math.max(48, o))),
        (this.a2 = G.fromHueAndChroma(a, 16)),
        (this.a3 = G.fromHueAndChroma(a + 60, 24)),
        (this.n1 = G.fromHueAndChroma(a, 4)),
        (this.n2 = G.fromHueAndChroma(a, 8))),
  ...
  static quantize(t, r, n) {
    ...
    for (let y = 0; y < t.length; y++) {
      const k = t[y],
        A = a.get(k);
      A === void 0
        ? (u++, o.push(c.fromInt(k)), s.push(k), a.set(k, 1))
        : a.set(k, A + 1);
    }
    const h = new Array();
    for (let y = 0; y < u; y++) {
    ...
    if (r.length === 0 && p > 0)
      for (let y = 0; y < p; y++) {
        const k = Math.random() * 100,
          A = Math.random() * (100 - -100 + 1) + -100,
          D = Math.random() * (100 - -100 + 1) + -100;
    ...
    for (let y = 0; y < ee; y++) {
      ...
      for (let P = 0; P < u; P++) {
        ...
        U !== -1 &&
          Math.abs(Math.sqrt(Y) - Math.sqrt(V)) > re &&
          (k++, (f[P] = U));
      }
      if (k === 0 && y !== 0) break;
...
class se {
  ...
  constructHistogram(t) {
    ...
    for (const [n, a] of r.entries()) {
      const o = dt(n),
        ...
        l = (s >> u) + 1,
        d = (c >> u) + 1,
        p = this.getIndex(h, l, d);
      (this.weights[p] = (this.weights[p] ?? 0) + a),
        (this.momentsR[p] += a * o),
        (this.momentsG[p] += a * s),
        (this.momentsB[p] += a * c),
        (this.moments[p] += a * (o * o + s * s + c * c));
    }
  }
  computeMoments() {
    for (let t = 1; t < W; t++) {
      const r = Array.from({ length: W }).fill(0),
        n = Array.from({ length: W }).fill(0),
        a = Array.from({ length: W }).fill(0),
        o = Array.from({ length: W }).fill(0),
        s = Array.from({ length: W }).fill(0);
      for (let c = 1; c < W; c++) {
        let u = 0,
          h = 0,
          l = 0,
        ...
        for (let f = 1; f < W; f++) {
          ...
          (this.weights[M] = this.weights[g] + r[f]),
            (this.momentsR[M] = this.momentsR[g] + n[f]),
            (this.momentsG[M] = this.momentsG[g] + a[f]),
            (this.momentsB[M] = this.momentsB[g] + o[f]),
            (this.moments[M] = this.moments[g] + s[f]);
        }
      }
    }
  }
  createBoxes(t) {
    ...
    let n = t,
      a = 0;
    for (let o = 1; o < t; o++) {
      this.cut(this.cubes[a], this.cubes[o])
        ? ((r[a] = this.cubes[a].vol > 1 ? this.variance(this.cubes[a]) : 0),
          (r[o] = this.cubes[o].vol > 1 ? this.variance(this.cubes[o]) : 0))
        : ((r[a] = 0), o--),
        (a = 0);
      let s = r[0];
  ...
  createResult(t) {
    const r = [];
    for (let n = 0; n < t; ++n) {
      const a = this.cubes[n],
        o = this.volume(a, this.weights);
      if (o > 0) {
        const s = Math.round(this.volume(a, this.momentsR) / o),
          c = Math.round(this.volume(a, this.momentsG) / o),
          u = Math.round(this.volume(a, this.momentsB) / o),
          h = (255 << 24) | ((s & 255) << 16) | ((c & 255) << 8) | (u & 255);
        r.push(h);
      }
    }
    return r;
  ...
  cut(t, r) {
    const n = this.volume(t, this.momentsR),
      ...
      s = this.volume(t, this.weights),
      c = this.maximize(t, _.RED, t.r0 + 1, t.r1, n, a, o, s),
      u = this.maximize(t, _.GREEN, t.g0 + 1, t.g1, n, a, o, s),
      h = this.maximize(t, _.BLUE, t.b0 + 1, t.b1, n, a, o, s);
    let l;
    const d = c.maximum,
      p = u.maximum,
      f = h.maximum;
    if (d >= p && d >= f) {
      if (c.cutLocation < 0) return !1;
      l = _.RED;
    ...
    return (
      ...
      (r.vol = (r.r1 - r.r0) * (r.g1 - r.g0) * (r.b1 - r.b0)),
      !0
    );
  }
  maximize(t, r, n, a, o, s, c, u) {
    const h = this.bottom(t, r, this.momentsR),
      l = this.bottom(t, r, this.momentsG),
      d = this.bottom(t, r, this.momentsB),
      p = this.bottom(t, r, this.weights);
    let f = 0,
      M = -1,
      g = 0,
      b = 0,
    ...
    for (let k = n; k < a; k++) {
      if (
        ((g = h + this.top(t, r, k, this.momentsR)),
        (b = l + this.top(t, r, k, this.momentsG)),
        (w = d + this.top(t, r, k, this.momentsB)),
        (y = p + this.top(t, r, k, this.weights)),
        y === 0)
      )
        continue;
      let A = (g * g + b * b + w * w) * 1,
  ...
  volume(t, r) {
    return (
      r[this.getIndex(t.r1, t.g1, t.b1)] -
  ...
  bottom(t, r, n) {
    switch (r) {
      case _.RED:
        return (
          -n[this.getIndex(t.r0, t.g1, t.b1)] +
          n[this.getIndex(t.r0, t.g1, t.b0)] +
          n[this.getIndex(t.r0, t.g0, t.b1)] -
          n[this.getIndex(t.r0, t.g0, t.b0)]
        );
      case _.GREEN:
        return (
          -n[this.getIndex(t.r1, t.g0, t.b1)] +
          n[this.getIndex(t.r1, t.g0, t.b0)] +
          n[this.getIndex(t.r0, t.g0, t.b1)] -
          n[this.getIndex(t.r0, t.g0, t.b0)]
        );
      case _.BLUE:
        return (
          -n[this.getIndex(t.r1, t.g1, t.b0)] +
          n[this.getIndex(t.r1, t.g0, t.b0)] +
          n[this.getIndex(t.r0, t.g1, t.b0)] -
          n[this.getIndex(t.r0, t.g0, t.b0)]
        );
  ...
  top(t, r, n, a) {
    switch (r) {
      case _.RED:
        return (
          a[this.getIndex(n, t.g1, t.b1)] -
          a[this.getIndex(n, t.g1, t.b0)] -
          a[this.getIndex(n, t.g0, t.b1)] +
          a[this.getIndex(n, t.g0, t.b0)]
        );
      case _.GREEN:
        return (
          a[this.getIndex(t.r1, n, t.b1)] -
          a[this.getIndex(t.r1, n, t.b0)] -
          a[this.getIndex(t.r0, n, t.b1)] +
          a[this.getIndex(t.r0, n, t.b0)]
        );
      case _.BLUE:
        return (
          a[this.getIndex(t.r1, t.g1, n)] -
          a[this.getIndex(t.r1, t.g0, n)] -
          a[this.getIndex(t.r0, t.g1, n)] +
          a[this.getIndex(t.r0, t.g0, n)]
        );
      default:
        throw new Error("unexpected direction $direction");
    }
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const he = { desired: 4, fallbackColorARGB: 4282549748, filter: !0 };
function fe(e, t) {
...
class H {
  constructor() {}
  static score(t, r) {
    const { desired: n, fallbackColorARGB: a, filter: o } = { ...he, ...r },
      s = [],
      c = new Array(360).fill(0);
    let u = 0;
    ...
    const l = new Array();
    for (const f of s) {
      const M = Ot(Math.round(f.hue)),
        g = h[M];
      if (o && (f.chroma < H.CUTOFF_CHROMA || g <= H.CUTOFF_EXCITED_PROPORTION))
        continue;
      const b = g * 100 * H.WEIGHT_PROPORTION,
        w =
          f.chroma < H.TARGET_CHROMA
            ? H.WEIGHT_CHROMA_BELOW
            : H.WEIGHT_CHROMA_ABOVE,
        y = (f.chroma - H.TARGET_CHROMA) * w,
        k = b + y;
    ...
    for (let f = 90; f >= 15; f--) {
      d.length = 0;
      for (const { hct: M } of l)
        if ((d.find((b) => Nt(M.hue, b.hue) < f) || d.push(M), d.length >= n))
          break;
      if (d.length >= n) break;
    }
    const p = [];
 ...
 */ function F(e) {
  const t = dt(e),
    r = mt(e),
    n = gt(e),
    a = [t.toString(16), r.toString(16), n.toString(16)];
...
function de(e) {
  ...
  return (
    t
      ? ((a = J(e.slice(0, 1).repeat(2))),
        (o = J(e.slice(1, 2).repeat(2))),
        (s = J(e.slice(2, 3).repeat(2))))
      : r
      ? ((a = J(e.slice(0, 2))), (o = J(e.slice(2, 4))), (s = J(e.slice(4, 6))))
      : n &&
        ((a = J(e.slice(2, 4))),
        (o = J(e.slice(4, 6))),
        (s = J(e.slice(6, 8)))),
    ((255 << 24) | ((a & 255) << 16) | ((o & 255) << 8) | (s & 255)) >>> 0
  );
}
function J(e) {
 ...
 */ async function me(e) {
  const t = await new Promise((s, c) => {
      ...
      const l = () => {
        ...
        p &&
          /^\d+(\s*,\s*\d+){3}$/.test(p) &&
          (d = p.split(/\s*,\s*/).map((w) => parseInt(w, 10)));
        const [f, M, g, b] = d;
...
function Pt(e) {
  ...
  return (
    (t.dark.surfaceDim = F(e.palettes.neutral.tone(6))),
    (t.dark.surface = F(e.palettes.neutral.tone(6))),
    (t.dark.surfaceBright = F(e.palettes.neutral.tone(24))),
    (t.dark.surfaceContainerLowest = F(e.palettes.neutral.tone(4))),
    (t.dark.surfaceContainerLow = F(e.palettes.neutral.tone(10))),
    (t.dark.surfaceContainer = F(e.palettes.neutral.tone(12))),
    (t.dark.surfaceContainerHigh = F(e.palettes.neutral.tone(17))),
    (t.dark.surfaceContainerHighest = F(e.palettes.neutral.tone(22))),
    (t.dark.onSurface = F(e.palettes.neutral.tone(90))),
    (t.dark.onSurfaceVariant = F(e.palettes.neutralVariant.tone(80))),
    (t.dark.outline = F(e.palettes.neutralVariant.tone(60))),
    (t.dark.outlineVariant = F(e.palettes.neutralVariant.tone(30))),
    (t.light.surfaceDim = F(e.palettes.neutral.tone(87))),
    (t.light.surface = F(e.palettes.neutral.tone(98))),
    (t.light.surfaceBright = F(e.palettes.neutral.tone(98))),
    (t.light.surfaceContainerLowest = F(e.palettes.neutral.tone(100))),
    (t.light.surfaceContainerLow = F(e.palettes.neutral.tone(96))),
    (t.light.surfaceContainer = F(e.palettes.neutral.tone(94))),
    (t.light.surfaceContainerHigh = F(e.palettes.neutral.tone(92))),
    (t.light.surfaceContainerHighest = F(e.palettes.neutral.tone(90))),
    (t.light.onSurface = F(e.palettes.neutral.tone(10))),
    (t.light.onSurfaceVariant = F(e.palettes.neutralVariant.tone(30))),
    (t.light.outline = F(e.palettes.neutralVariant.tone(50))),
    (t.light.outlineVariant = F(e.palettes.neutralVariant.tone(80))),
    t
  );
}
async function pe(e) {
  ...
  try {
    ...
    let n = new Blob();
    if (
      (typeof t == "string" && (n = await fetch(t).then((s) => s.blob())),
      t.size && (n = t),
      t.files && t.files[0] && (n = t.files[0]),
      t.target &&
        t.target.files &&
        t.target.files[0] &&
        (n = t.target.files[0]),
